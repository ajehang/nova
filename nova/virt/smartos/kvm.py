...
def get_connection(_=None):
    ...
    return SmartKvmConnection.instance()


class SmartKvmInstance(object):
...
class SmartKvmConnection(driver.ComputeDriver):
    ...
    def _map_to_instance_info(self, instance):
        instance = utils.check_isinstance(instance, SmartKvmInstance)
    ...
    def plug_vifs(self, instance, network_info):
        ...
        # manipulate networks via crossbow
        pass
    ...
    def spawn(self, context, instance, image_meta,
        ...
        # create vm - vmadm create < vm.json
        name = instance.name
        state = power_state.RUNNING
        fake_instance = SmartKvmInstance(name, state)
